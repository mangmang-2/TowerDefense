...
TOWERDEFENSE_API DECLARE_LOG_CATEGORY_EXTERN(LogGameplayMessageSubsystem, Log, All);
...
struct TOWERDEFENSE_API FGameplayMessageListenerHandle
{
public:
	GENERATED_BODY()
 ...
 */
UCLASS()
class TOWERDEFENSE_API UGameplayMessageSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
